        ...
        <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-body font-medium">
                  <li className="mb-4">
                    <a href="https://flowbite.com/" className="hover:underline">Tailwind Mod</a>
                  </li>
                  <li>
                    <a href="https://tailwindcss.com/" className="hover:underline">OG Tailwind CSS</a>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-body font-medium">
                  <li className="mb-4">
                    <a href="https://github.com/Priyes-h/Parking-Management-system-React" className="hover:underline ">Github</a>
                  </li>
                  <li>
                    <a href="https://github.com/Priyes-h/Parking-Management-system-React" className="hover:underline">Discord</a>
                  </li>
                </ul>
              </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <span className="text-sm text-body sm:text-center">
              © 2026 <a href="https://github.com/Priyes-h/Parking-Management-system-React" className="hover:underline">ParkNow™</a>. All Rights Reserved.
            </span>

            {/* Social icons group - quick links to social profiles */}

            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a href="https://www.instagram.com/priyesh._5/" className="text-body hover:text-heading">
              ...
              <a href="https://www.instagram.com/parallel_plate_capacitor?igsh=MW9pMmRjbHQ2NzlxaA==" className="text-body hover:text-heading ml-5">
              ...
              <a href="https://www.youtube.com/@ayushmaandaksh6185" className="text-body hover:text-heading ms-5">
              ...
              <a href="https://www.zomato.com/" className="text-body hover:text-heading ms-5">
